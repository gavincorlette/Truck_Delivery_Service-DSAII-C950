...
# Create truck class
class Truck:
    def __init__ (self, avg_speed, package_list, current_address, departure_time, status, mileage):
    ...
    def __str__(self):
        return f'{self.avg_speed}, {self.package_list}, {self.current_address}, {self.departure_time}, {self.status}, {self.mileage}'
